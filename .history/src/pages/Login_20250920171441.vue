<template>
  <div class="login-container">
    ...
    <router-link to="/register" class="register-link">Registrar novo usuário</router-link> <router-link to="/register" class="register-link">Registrar novo usuário</router-link>
  </div>
</template>
