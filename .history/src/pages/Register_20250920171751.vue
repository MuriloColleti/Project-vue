          ...
          <div class="card-body">
            ...
            <form @submit.prevent="handleRegister">
              <div class="mb-3">
                ...
                <input type="text" id="newUsername" v-model="newUsername" required class="form-control" />
              </div>
              <div class="mb-3">
                <label for="newEmail" class="form-label">Email:</label>
                <input type="email" id="newEmail" v-model="newEmail" required class="form-control" />
              </div>
              <div class="mb-3">
            ...
            <ul class="list-group">
              <li v-for="user in users" :key="user.id" class="list-group-item">
                <strong>ID:</strong> {{ user.id }} | <strong>Usuário:</strong> {{ user.username }} | <strong>Email:</strong> {{ user.email }}
              </li>
            </ul>
          </div>
        </div>
